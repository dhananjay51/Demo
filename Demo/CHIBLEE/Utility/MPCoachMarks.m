...
- (void)goToCoachMarkIndexed:(NSUInteger)index {
   ...
   //     NSDictionary *coachMarkInfo = [self.coachMarks objectAtIndex:markIndex];
    //    CGRect frame = [[coachMarkInfo objectForKey:@"rect"] CGRectValue];
        NSDictionary *coachMarkInfo = markDef;
        CGRect frame = markRect;
        ...
        else if((swipeDirection != nil) && ([swipeDirection isEqualToString:@"downtoup"])){
            direction=kCircleSwipeDownToUp;
                  }
  ...
  */      
    ...
    self.lblCaption.textColor=[UIColor colorWithRed:14.0/255.0 green:106.0/255.0 blue:63.0/255.0 alpha:1];
    ...
    switch (labelPosition) {
        case LABEL_POSITION_TOP:
        {
            ...
            if(showArrow) {
                ...
                imageViewFrame.origin.x = x+45;
                imageViewFrame.origin.y = y-10;
                self.arrowImage.frame = imageViewFrame;
                y -= (self.arrowImage.frame.size.height + kLabelMargin);
                self.arrowImage.image = [ [UIImage imageNamed:@"arrow-down"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
                [self.arrowImage setTintColor:[UIColor colorWithRed:14.0/255.0 green:106.0/255.0 blue:63.0/255.0 alpha:1]
];
        ...
        case LABEL_POSITION_RIGHT_BOTTOM:
        {
            ...
            if(showArrow) {
                ...
                self.arrowImage.frame = imageViewFrame;
                self.arrowImage.image = [ [UIImage imageNamed:@"arrow-top"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
                [self.arrowImage setTintColor:[UIColor colorWithRed:14.0/255.0 green:106.0/255.0 blue:63.0/255.0 alpha:1]
];
                [self addSubview:self.arrowImage];
            }
