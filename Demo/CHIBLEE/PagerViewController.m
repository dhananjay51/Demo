...
- (void)viewDidLoad
{
    ...
    if (check==YES) {
       ...
       ///[self performSegueWithIdentifier:@"Login" sender:nil];x
    }
...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration {
	...
	self.scrollView.contentSize = CGSizeMake(scrollView.frame.size.width * [self.childViewControllers count],0);
	   NSUInteger page = 0;
